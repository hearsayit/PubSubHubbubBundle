...
/**
 * Dummy topic provider which should only be used for debugging.  Just creates
 * BasicTopic instances.
 * @package HearsayPubSubHubbubBundle
 * @subpackage Topic
 * @author Kevin Montag <kevin@hearsay.it>
 */
class BasicTopicProvider implements TopicProviderInterface {
    
    /**
     * {@inheritdoc}
     */
    public function getTopic($topicId) {
        return new BasicTopic($topicId);
    }
}
